...
namespace TestConsoleApplication
{
    internal class Program
    {
        private static string _connectionString =
            @"Host=risadtest;Port=5432;Database=Risad2;User ID=postgres;Password=mipsa;";
        ...
        private static async Task Main(string[] args)
        {
            ...
            PerformikaPostModule postModule = new PerformikaPostModule("http://10.10.1.141:8080/api",
                "risad-change@mail.ru", "Risadchange1_");
            DbLoader loader = new DbLoader(_connectionString);


            PerformikaGetModule getModule =
                new PerformikaGetModule("https://asurisad.fad.ru/api", "risad-change@mail.ru", "Risadchange1_");
			...
			*/
            ...
            try
            {
                ...
                */
                ...
                //Участки дорог
                //List<Guid> performikaGuids = await postModule.GetUidsAsync(
                //    "/gridview?definitionId=1be20f82-ff64-4b3a-bb38-920a8d7b2bfe&_=1615965457226",
                //    "47f5d6b9-3c0c-43f0-a99a-93692565b05e");
                //int count = loader.DeleteRows("public.\"ChildRoad\"", "\"ChildObjectUid\"", performikaGuids);
                //Console.WriteLine($"Удалено {count} записей.");
                ...
                //    "47f5d6b9-3c0c-43f0-a99a-93692565b05e");
                //int count = loader.DeleteRows("public.\"ChildISSO\"", "\"ChildObjectUid\"", performikaGuids);
                //Console.WriteLine($"Удалено {count} записей.");
                ...
                int count = loader.DeleteRows("dic.\"ISSO\"", "\"ObjectUid\"", performikaGuids);
                Console.WriteLine($"Удалено {count} записей.");
            }
            catch (Exception ex)
            {
